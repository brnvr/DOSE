...
var u_pressed_keys = shader_get_uniform(shader, "pressedKeys")
var u_texture_dimensions = shader_get_uniform(shader, "textureDimensions")
var u_key = shader_get_uniform(shader, "key")
var u_highlight_key = shader_get_uniform(shader, "highlightKey")
var u_highlight_color = shader_get_uniform(shader, "highlightColor")
...
shader_set_uniform_f_array(u_texture_dimensions, [width, height])
