...
global.seed_groups[realms.thisside][sg.items] = [obj_currant_syrup, obj_lucky_frog]
...
global.seed_groups[realms.otherside][sg.items] = [obj_currant_syrup, obj_lucky_frog]
