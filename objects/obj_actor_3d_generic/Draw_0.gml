if (view_current == views.view_3d) {
	...
	shader_set_uniform_f(u_mesh_fog_start, obj_game_control.fog_start)
	shader_set_uniform_f(u_mesh_fog_end, obj_game_control.fog_end)
	shader_set_uniform_f_array(u_mesh_light_direction, obj_game_control.light_direction)
	...
	shader_set_uniform_f_array(u_mesh_shadow_color, color_get_normalized(obj_game_control.fog_color))
	event_user(15)
