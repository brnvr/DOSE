...
var _game_view_palette = [
    ...
    make_color_rgb(49, 18, 16),      // #311210
    make_color_rgb(102, 40, 34),     // #662822
    make_color_rgb(136, 60, 51),     // #883c33
    make_color_rgb(25, 56, 23),      // #193817
    make_color_rgb(64, 51, 18),      // #403312
    make_color_rgb(109, 69, 29),     // #6d451d
    make_color_rgb(162, 99, 47),     // #a2632f
    make_color_rgb(62, 102, 50),     // #3e6632
    make_color_rgb(106, 124, 49),    // #6a7c31
    make_color_rgb(170, 151, 59),    // #aa973b
    make_color_rgb(202, 167, 80),    // #caa750
    make_color_rgb(102, 172, 69),    // #66ac45
    make_color_rgb(150, 194, 76),    // #96c24c
    make_color_rgb(202, 224, 93),    // #cae05d
    make_color_rgb(227, 230, 109),   // #e3e66d
    make_color_rgb(12, 15, 45),      // #0c0f2d
    make_color_rgb(55, 38, 58),      // #37263a
    make_color_rgb(107, 50, 85),     // #6b3255
    make_color_rgb(159, 61, 109),    // #9f3d6d
    make_color_rgb(39, 61, 69),      // #273d45
    make_color_rgb(84, 80, 88),      // #545058
    make_color_rgb(128, 85, 99),     // #805563
    make_color_rgb(184, 119, 112),   // #b87770
    make_color_rgb(70, 115, 96),     // #467360
    make_color_rgb(103, 132, 101),   // #678465
    make_color_rgb(170, 160, 139),   // #aaa08b
    make_color_rgb(218, 174, 148),   // #daae94
    make_color_rgb(117, 178, 126),   // #75b27e
    make_color_rgb(150, 201, 136),   // #96c988
    make_color_rgb(206, 224, 154),   // #cee09a
    make_color_rgb(231, 231, 174),   // #e7e7ae
    make_color_rgb(37, 29, 109),     // #251d6d
    make_color_rgb(71, 38, 134),     // #472686
    make_color_rgb(116, 60, 153),    // #743c99
    make_color_rgb(180, 84, 192),    // #b454c0
    make_color_rgb(51, 70, 141),     // #33468d
    make_color_rgb(87, 80, 179),     // #5750b3
    make_color_rgb(137, 102, 209),   // #8966d1
    make_color_rgb(207, 137, 206),   // #cf89ce
    make_color_rgb(83, 141, 183),    // #538db7
    make_color_rgb(124, 162, 211),   // #7ca2d3
    make_color_rgb(177, 176, 215),   // #b1b0d7
    make_color_rgb(236, 187, 228),   // #ecbbe4
    make_color_rgb(121, 194, 201),   // #79c2c9
    make_color_rgb(174, 217, 214),   // #aed9d6
    make_color_rgb(213, 245, 242),   // #d5f5f2
