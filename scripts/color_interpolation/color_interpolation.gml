function color_interpolation(src_color, dest_color, value) {
	...
	r = linear_interpolation(src_r, dest_r, value);
	g = linear_interpolation(src_g, dest_g, value);
	b = linear_interpolation(src_b, dest_b, value);
